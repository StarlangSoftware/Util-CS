...
namespace Util
{
    public class RandomNormalizedArray
    {
        ...
        /**
         * <summary>The constructor of {@link RandomNormalizedArray} class gets an integer itemCount as an input. Creates an array of
         ...
         *
         * <returns>the double {@link java.lang.reflect.Array}.</returns>
         */
        public double[] Get() {
            return _array;
        }
